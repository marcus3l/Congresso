...
function modeloArquivoModel ($class_name = null, $table = null, $primary_key = 'id', $isset_updated_at = 'true', $isset_deleted_at = 'false' ) {
    if ( $class_name === null || $table === null) 
        return false;
    ...
    <?php
        class $class_name extends CI_Model {
            ...
            protected \$id 		= '$primary_key';

            private \$updated_at = $isset_updated_at;
            private \$deleted_at = $isset_deleted_at;
